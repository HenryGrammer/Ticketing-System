...
<?php 
$qry = $conn->query("SELECT t.*,concat(c.lastmame,', ',c.firstname,' ',c.middlename) as cname, d.name as dname FROM tickets t inner join customers c on c.id= t.customer_id inner join departments d on d.id = t.department_id  where  t.id = ".$_GET['id'])->fetch_array();
foreach($qry as $k => $v){
	$$k = $v;
}
?>
					...
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<label for="" class="control-label border-bottom border-primary">Need Support Form</label>
